# ROADMAP — blackroad.company

> Product roadmap for BlackRoad Company
...
- [ ] Deploy index.html to blackroad.company
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroad.company with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: Company, RoadAuth, RoadPay, Corporate Governance
...
**Milestone**: First paying customer through blackroad.company.
...
**Milestone**: blackroad.company is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: corporate | Products: Company, RoadAuth, RoadPay, Corporate Governance*
